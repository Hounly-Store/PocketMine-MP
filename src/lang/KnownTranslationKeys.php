...
final class KnownTranslationKeys{
	...
	public const POCKETMINE_WORLD_AMBIGUOUSFORMAT = "pocketmine.world.ambiguousFormat";
	public const POCKETMINE_WORLD_BACKGROUNDGENERATION = "pocketmine.world.backgroundGeneration";
	public const POCKETMINE_WORLD_BADDEFAULTFORMAT = "pocketmine.world.badDefaultFormat";
	public const POCKETMINE_WORLD_CONVERSION_FINISH = "pocketmine.world.conversion.finish";
	public const POCKETMINE_WORLD_CONVERSION_START = "pocketmine.world.conversion.start";
	public const POCKETMINE_WORLD_CORRUPTED = "pocketmine.world.corrupted";
	public const POCKETMINE_WORLD_DEFAULTERROR = "pocketmine.world.defaultError";
	public const POCKETMINE_WORLD_GENERATIONERROR = "pocketmine.world.generationError";
	public const POCKETMINE_WORLD_INVALIDGENERATOROPTIONS = "pocketmine.world.invalidGeneratorOptions";
	public const POCKETMINE_WORLD_LOADERROR = "pocketmine.world.loadError";
	public const POCKETMINE_WORLD_NOTFOUND = "pocketmine.world.notFound";
	public const POCKETMINE_WORLD_PREPARING = "pocketmine.world.preparing";
	public const POCKETMINE_WORLD_SPAWNTERRAINGENERATIONPROGRESS = "pocketmine.world.spawnTerrainGenerationProgress";
	public const POCKETMINE_WORLD_UNKNOWNFORMAT = "pocketmine.world.unknownFormat";
	public const POCKETMINE_WORLD_UNKNOWNGENERATOR = "pocketmine.world.unknownGenerator";
	public const POCKETMINE_WORLD_UNLOADING = "pocketmine.world.unloading";
	public const POCKETMINE_WORLD_UNSUPPORTEDFORMAT = "pocketmine.world.unsupportedFormat";
